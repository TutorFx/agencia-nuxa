<template>
  <div
    class="rounded-xl overflow-hidden relative group border border-transparent hover:border-nuxa-300/10 hover:shadow-xl transition-all duration-500">
    ...
    <div class="grid justify-center bg-background-400/20 backdrop-blur-[80px] py-8 px-12 gap-6 h-full items-start"
      ref="cardEl">
      ...
      <div class="font-bold text-lg text-center pointer-events-none grow">
        <slot name="head" />
      </div>
